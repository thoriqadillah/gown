    ...
    <v-layout >
      <v-navigation-drawer v-model="drawer" :elevation="0" expand-on-hover rail :border="0" location="right">
        <v-list density="compact" nav class="tw-flex tw-flex-col tw-mt-12">
          ...
          <v-list-item active-color="primary" :active="settingDialog" prepend-icon="mdi-cog-outline" title="Settings" value="settings">
            <setting-dialog @dialog="(val: boolean) => settingDialog = val"/>
          </v-list-item>
